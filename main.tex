...
\begin{tcbposter}[
    ...
    \posterbox[adjusted title=Problem]{
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item exact diagonalization cannot handle many sites $N$,
                  ...
                  \end{equation*}
            \item idea: add more sites but do not consider all possible states,
                  polynomial scaling $N^p$
    ...
    \posterbox[adjusted title=Method]{
        ...
        \begin{itemize}[leftmargin=*]
            \item Lanczos algorithm coupling impurity to hundreds of bath sites~\cite{Lu2014,Lu2019}
            \item represent functions using poles without any broadening
                  \begin{equation*}
                      f(\omega) = \sum_j \frac{w_j}{\omega +\mathrm{i}0^+-\epsilon_j}
                  \end{equation*}
    ...
    \posterbox[adjusted title=Spectral function $A(\omega)$]{
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item[\color{green}$\boldcheckmark$] sharp peaks at inner edge of Hubbard bands (cf.~\cite{Lee2017})
